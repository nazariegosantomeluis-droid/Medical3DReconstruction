...
<style>
  :root {
    --bg: #161310; --surface: #1e1a15; --surface-raised: #27221a; --border: #3a3225;
    --text: #f1e9da; --text-dim: #a89a83; --text-faint: #71644f;
    --accent: #d17d3a; --accent-soft: rgba(209,125,58,0.16); --accent-strong: #b3611f;
    --accent-ink: #2a1a0d;
    --warn: #d9a23c; --ok: #7fa15c;
  ...
  :root[data-theme="light"] {
    --bg: #f5efe2; --surface: #fffcf5; --surface-raised: #efe6d2; --border: #ddccab;
    --text: #251f16; --text-dim: #6b5d47; --text-faint: #a29170;
    --accent: #a8501f; --accent-soft: rgba(168,80,31,0.11); --accent-strong: #7e3c17;
    --accent-ink: #fff6ea;
  }
